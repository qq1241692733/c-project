...
//	LCD_ShowString(28,340,840,16,24,"|------------|-----------|-----------|-----------|-----------|"); 
  ...
  LCD_ShowxNum(458,160,a3,8,24,0);    //显示	
	...
	while(1)   // PF10 CW转向    PF9 CLK脉冲    PF4 EN使能 
	{
		isfull();
		if(a1 >= 8) {
				Show_Str(320,310,840,24,"可回收垃圾  已满载！",24,0 ); 	
		}
		a=garbage_ret();
		if(a!=0)					
			break;
	...
	switch(a)   
	{
		...
		case 2:   //2号桶    有害垃圾   PF13
			  ...
			  TIM_SetCompare1(TIM10,20000-2160);  //关	 左13
				...
				Show_Str(336,408,250,24,"  有害垃圾    OK！",24,0);
				POINT_COLOR=RED;  
		...
		case 3:   //3号桶     厨余垃圾   PF14
			  ...
			  TIM_SetCompare1(TIM10,20000-2160);  //关	 左13
				...
				Show_Str(336,408,250,24,"  厨余垃圾    OK！",24,0);
				POINT_COLOR=RED;  
				LCD_ShowxNum(260,408,count,8,24,1);    //显示
		...
		case 4:   // 4号桶     其他垃圾   PF15
				...
				{
				  	LCD_ShowxNum((a-1)*144+120+(a4-5)*35,244,count,8,24,1);    //显示		
				}		
			  ...
			  TIM_SetCompare1(TIM10,20000-2160);  //关	 左13
				...
				Show_Str(336,408,250,24,"  其他垃圾    OK！",24,0);
				POINT_COLOR=RED;  
				LCD_ShowxNum(260,408,count,8,24,1);    //显示
