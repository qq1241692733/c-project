...
//	LCD_ShowxNum(170,160,b1,8,24,0);    //显示
//	LCD_ShowxNum(340,160,b2,8,24,0);    //显示
//  LCD_ShowxNum(480,160,b3,8,24,0);    //显示	
//	LCD_ShowxNum(620,160,b4,8,24,0);    //显示			
			while(1)
			{
			...
			switch(a)   
			{
				...
				case 1:   //1号桶    可回收垃圾  PF1
					  ...
					  LCD_ShowxNum(170,160,a1,8,24,0);    //显示
						...
						TIM_SetCompare1(TIM14,20000-1550);			
						delay_ms(1500);
						TIM_SetCompare1(TIM14,20000-1150);  //关
						delay_ms(2000);	
